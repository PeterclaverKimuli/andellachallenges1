...
class ShoppingListApp:
    ...
    def get_user(self, username):
        """
        This method gets an instance of the User from the user dictionary using the
        username
        :param username:
        :return:
        """
    ...
    def generate_random_key(self):
        """
        This method generates a random string to act as an Id when creating a shopping list and
        shopping list items
        :return:
        """
